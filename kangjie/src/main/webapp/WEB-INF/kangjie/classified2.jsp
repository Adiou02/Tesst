								...
								<div class="panel-body" style="height: 280px;">	
									<div class="panel-body-1">
										...
										<div class="panel-body-3">
											...
											<div class="panel-body-3-3"></div>
											<div class="panel-body-3-4">建议均衡营养加强锻炼磷脂酰胆碱等。</div>
										</div>
					...
					<div class="row" style="margin-top: 0px;">
						<div class="col-md-12">
							<div class="panel">
								<div class="panel-heading">
									<div>
										<p class="before-result">报告分类：</p>
										<p class="before-result-value-red">严重</p>
									</div>
									<div style="clear:both"></div>
									<div>
										<div class="panel-heading-advice">建议</div>
										<div class="panel-heading-advice-blue"></div>
										<div class="panel-heading-advice2">定期素食更利于您的健康；注意及时释放自我压力，避免及减轻对肝肾的慢性伤害。* 胃功能弱，偶有胀气</div>
									</div>
									<div style="clear:both"></div>
								</div>
							</div>
